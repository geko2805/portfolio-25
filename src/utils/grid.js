...
var Grid = (function () {
  ...
  Preview.prototype = {
    create: function () {
      ...
      this.$href = $('<a href="#" class="internal_link">View Project</a>');
      //this.$href2 = $( '<a href="#" class="external_link" target="_blank">Visit Website</a>' );

      this.$details = $('<div class="og-details"></div>').append(
        this.$title,
        this.$description /*this.$href , this.$href2*/
      );
    ...
    update: function ($item) {
      ...
      $(".og-details").append(this.$href);

      //create apropriate buttons for href or external url stored in dataset href2
      /*var idn= $itemEl.data( 'title' );
			var internallink= $itemEl.attr( 'href' );
			var externallink= $itemEl.data( 'href2' );
      ...
      //this.$href2 = $( '<a class="directlink" href="#">Visit Website</a>' );
      //remove any existing link
      //$( '.directlink').remove();
      //if there is a second href, update href to link direct to that
      /*if(!externallink){
				//this.$href.parent().append(this.$href2);
			//this.$href2.remove();

			$('.external_link[title*='+ title + ']').remove() ;

				


				//.$href2 = $( '<a href="#">View Project</a>' );
